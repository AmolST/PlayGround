...
namespace CalculatorUnitTestProject
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("SimpleCalculator", Description="\tIn order to avoid silly mistakes\r\n\tAs a math idiot\r\n\tI want to be told the sum o" +
        "f two numbers", SourceFile="SimpleCalculator.feature", SourceLine=0)]
